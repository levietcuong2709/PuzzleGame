...
public class ButtonEvent extends JPanel implements ActionListener {
    ...
    public void execute(Point p1, Point p2) {
        ...
        String filepath = "D:\\Netbeans\\My Game\\PuzzleGame\\Music\\sound.wav";
        Music musicObject = new Music();
        musicObject.soundMusic(filepath);
    }
        ...
        if (p1 == null) {
            ...
            if (item == 0) {
                if (frame.showDialogNewGame(
                        "Bạn là người chiến thắng!\nBạn có muốn chơi lại không?", "Thắng", 1) == true) {
                };
            }
        }
    }
