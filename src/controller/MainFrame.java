...
public class MainFrame extends JFrame implements ActionListener, Runnable {
    ...
    private JPanel createControlPanel() {
        ...
        panelControl.add(btnNewGame = createButton("Trò chơi mới"),
                BorderLayout.PAGE_END);


        // use panel set Layout BorderLayout to panel control in top
        JPanel panel = new JPanel(new BorderLayout());
        panel.setBorder(new TitledBorder("Chào mừng đến với Pokemon"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnNewGame) {
            showDialogNewGame("Trò chơi chưa kết thúc. Bạn có muốn chơi lại không?", "Cảnh báo", 0);
        }
